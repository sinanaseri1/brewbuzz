...
import { Settings, Coffee, Star, Calendar, Trash2 } from "lucide-react";
                                    ...
                                    >
                                        <div className="flex gap-4 p-4">
                                            ...
                                            <Link
                                                ...
                                                className="h-16 w-16 rounded bg-muted bg-cover bg-center shrink-0 border block"
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex justify-between items-start">
                                                    <div>
                                                        {/* 2. Link the Title */}
                                                        <Link href={`/coffees/${review.coffee_id}`} className="block">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {/* DELETE FORM - Now separated from links */}
                                                        <form action={async () => {
                                                            "use server";
